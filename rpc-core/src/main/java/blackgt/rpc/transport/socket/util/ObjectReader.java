package blackgt.rpc.transport.socket.util;
...
public class ObjectReader {
    ...
    public static Object readObject(InputStream in) throws IOException {
        ...
        Class<?> packageClass;
        if (packageCode == RpcPackageType.REQUEST_TYPE.getTypeCode()) {
            packageClass = RpcRequest.class;
        } else if (packageCode == RpcPackageType.RESPONSE_TYPE.getTypeCode()) {
